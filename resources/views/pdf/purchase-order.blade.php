...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>أمر شراء</h1>
            <p><strong>تاريخ الطلب:</strong> {{ Carbon\Carbon::parse($order->order_date)->format('Y-m-d') }}</p>
            <p><strong>رقم الطلب:</strong> #{{ sprintf('%04d', $order->id) }}</p>
        </div>
        ...
        <div class="details-grid">
            ...
            <div>
                ...
                <p><strong>العنوان:</strong> {{ $order->supplier->address }}</p>
                <p><strong>البريد الإلكتروني:</strong> {{ $order->supplier->email }}</p>
                <p><strong>الهاتف:</strong> {{ $order->supplier->phone_number }}</p>
            </div>
        </div>
        ...
        <p class="total">المجموع الإجمالي: {{ number_format($order->total_amount, 2) }} KES</p>
