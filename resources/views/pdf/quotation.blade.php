...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>عرض سعر</h1>
            <p><strong>تاريخ عرض السعر:</strong> {{ Carbon\Carbon::parse($quotation->quotation_date)->format('Y-m-d') }}</p>
            <p><strong>رقم عرض السعر:</strong> #{{ sprintf('%04d', $quotation->id) }}</p>
        </div>
        ...
        <div class="details-grid">
            ...
            <div>
                <h3>بيانات العميل</h3>
                <p><strong>الاسم:</strong> {{ $quotation->client->name }}</p>
                <p><strong>العنوان:</strong> {{ $quotation->client->address }}</p>
                <p><strong>البريد الإلكتروني:</strong> {{ $quotation->client->email }}</p>
                <p><strong>الهاتف:</strong> {{ $quotation->client->phone_number }}</p>
            </div>
        </div>
        ...
        <p class="total">المجموع الإجمالي: {{ number_format($quotation->total_amount, 2) }} KES</p>
